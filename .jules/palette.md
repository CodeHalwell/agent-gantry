...
## 2026-08-23 - [Keyboard Accessibility for ARIA Tablists]
...
**Action:** Always add explicit keyboard event handlers and proper `tabIndex` logic to tab elements to ensure keyboard-only users can navigate the tablist intuitively.
